...
// (Array of arrays)
var multi_array = [['karachi', 'lahore', 'Quetta'], ['apple', 'eggs', 'banana']];

// 2. Declare and initialize a multidimensional array
// representing the following matrix:
 var my_matrix = [[0, 1, 2, 3], [1, 0, 1, 2], [2, 1, 0, 1]];
 document.write(my_matrix)
...
document.write(' Multiplication table of ' + length + '<br />');
document.write(' Length ' + num + '<br />');
